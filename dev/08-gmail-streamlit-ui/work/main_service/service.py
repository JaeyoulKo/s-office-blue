...
from .gmail_reader import fetch_messages
...
def load_gmail_inbox(query: str, max_results: int = 20) -> list[dict[str, Any]]:
    return fetch_messages(query, max_results=max_results)
